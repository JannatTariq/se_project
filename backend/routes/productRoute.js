...
const { getAllProducts, createProduct, updateProduct, deleteProduct, getProductDetails, createReview, getAllReview, deleteReview } = require("../controllers/productController");
